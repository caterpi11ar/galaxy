...
│   ├── components/            # React 组件
│   │   └── game/              # 游戏特定组件
│   │       ├── UniverseCanvas.tsx    # 宇宙画布组件
│   │       ├── GameHeader.tsx        # 游戏头部导航
│   │       ├── GameControls.tsx      # 底部控制栏
│   │       ├── PlanetInfoPanel.tsx   # 星球信息面板
│   │       ├── OnlineStatus.tsx      # 在线状态显示
│   │       └── index.ts              # 组件导出
│   ├── lib/                   # 工具函数和配置
│   │   ├── mock-data.ts       # 模拟数据
│   │   └── index.ts           # 工具导出
...
│       ├── useUniverseGame.ts # 宇宙游戏逻辑
│       └── index.ts           # Hook 导出
├── PRPs/                      # 项目需求规划
│   ├── start.md               # 项目启动计划
│   ├── ui-design.md           # UI 设计任务清单
│   └── architecture-refactor.md # 架构重构计划
├── public/                    # 静态资源
│   ├── galaxy.svg             # Galaxy 图标
│   └── ...                    # 其他静态文件
